...
Worked alongside Milos for this project; we helped each other out.
*/
...
void initializeCache() {
    ...
    set_index_mask = (mem_addr_t)(pow_two(s) - 1);
}

/*
 * releaseCache - free allocated memory
 */
void releaseCache() {
    int i;
    for (i = 0; i < S; i++) {
